...
_PLUGGABLETERMINATION = _descriptor.Descriptor(
  name='PluggableTermination',
  full_name='mesos.PluggableTermination',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='mesos.PluggableTermination.status', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='killed', full_name='mesos.PluggableTermination.killed', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='message', full_name='mesos.PluggableTermination.message', index=2,
      number=3, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PLUGGABLESTATUS = _descriptor.Descriptor(
  name='PluggableStatus',
  full_name='mesos.PluggableStatus',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='mesos.PluggableStatus.message', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['PluggableTermination'] = _PLUGGABLETERMINATION
DESCRIPTOR.message_types_by_name['PluggableStatus'] = _PLUGGABLESTATUS
...
class PluggableTermination(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _PLUGGABLETERMINATION

  # @@protoc_insertion_point(class_scope:mesos.PluggableTermination)

class PluggableStatus(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _PLUGGABLESTATUS

  # @@protoc_insertion_point(class_scope:mesos.PluggableStatus)

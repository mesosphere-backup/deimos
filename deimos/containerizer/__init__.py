...
class Containerizer(object):
    ...
    def launch(self, launch_pb, *args): pass
    def update(self, update_pb, *args): pass
    def usage(self, usage_pb, *args): pass
    def wait(self, wait_pb, *args): pass
    def destroy(self, destroy_pb, *args): pass
